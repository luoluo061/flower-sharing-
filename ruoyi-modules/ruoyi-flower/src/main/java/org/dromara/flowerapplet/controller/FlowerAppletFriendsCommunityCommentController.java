...
@RestController
@RequestMapping("/flowerApplet/friendsCommunityComment")
// [MEILI-DOMAIN] Community
public class FlowerAppletFriendsCommunityCommentController extends BaseController {

    private final IFlowerAppletFriendsCommunityCommentService flowerAppletFriendsCommunityCommentService;
    ...
    public TableDataInfo<FlowerFriendsCommunityCommentVo> list(FlowerFriendsCommunityCommentBo bo, PageQuery pageQuery) {
        return flowerAppletFriendsCommunityCommentService.queryPageList(bo, pageQuery);
    }
    ...
    public void export(FlowerFriendsCommunityCommentBo bo, HttpServletResponse response) {
        List<FlowerFriendsCommunityCommentVo> list = flowerAppletFriendsCommunityCommentService.queryList(bo);
    ...
    public R<FlowerFriendsCommunityCommentVo> getInfo(@NotNull(message = "主键不能为空")
        ...
        return R.ok(flowerAppletFriendsCommunityCommentService.queryById(id));
    }
    ...
    public R<Void> add(@Validated(AddGroup.class) @RequestBody FlowerFriendsCommunityCommentBo bo) {
        return toAjax(flowerAppletFriendsCommunityCommentService.insertByBo(bo));
    }
    ...
    public R<Void> edit(@Validated(EditGroup.class) @RequestBody FlowerFriendsCommunityCommentBo bo) {
        return toAjax(flowerAppletFriendsCommunityCommentService.updateByBo(bo));
    }
    ...
    public R<Void> remove(@NotEmpty(message = "主键不能为空")
        ...
        return toAjax(flowerAppletFriendsCommunityCommentService.deleteWithValidByIds(List.of(ids), true));
    }
}
